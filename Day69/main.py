...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            flash('You are already register with the email, log in instead.')
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            flash("Username doesn't exist. Please register first.")
            return redirect(url_for('login'))
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if current_user.is_authenticated:
            ...
            flash("You need to log in to write a comment.")
            return redirect(url_for('login'))
